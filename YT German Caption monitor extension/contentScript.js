    ...
    if(getCaptionLanguageType.innerText.includes('German')){
        ...
        for(i = 0; i< allCaptionsTab.length; i++){
            ...
            if(allCaptionsTab[i].classList.contains('active')){
                ...
                // pass the active caption as parameter to a function called extractWords which will extract words
                let wordsToFind = extractWords(activeCaption)
                // find the words and their meaning inside the array from German word list
                let translatedSentence = findGermanMeaning(wordsToFind)
                document.getElementsByClassName('ytp-caption-segment')[0].innerText = translatedSentence
                console.log('works')
            }
        }
    }
